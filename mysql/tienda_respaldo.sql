...
INSERT INTO `clientes` VALUES (1,'PEDRO','PARAMO','5553698785','COMALA'),(2,'RAUL','ORTIZ','5553698785','COMALA'),(3,'JESUS','FERNANDEZ','5553698785','COMALA');
...
--
-- Table structure for table `cohorte12`
--

DROP TABLE IF EXISTS `cohorte12`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `cohorte12`
--

LOCK TABLES `cohorte12` WRITE;
/*!40000 ALTER TABLE `cohorte12` DISABLE KEYS */;
/*!40000 ALTER TABLE `cohorte12` ENABLE KEYS */;
UNLOCK TABLES;
